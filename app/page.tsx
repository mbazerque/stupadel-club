...
function FeatureCard({
  ...
  return (
    <div
      className={`group group-hover-outline-primary relative rounded-3xl border border-neutral-700/40 bg-card p-6 md:p-8 overflow-hidden transition-all duration-500 hover:border-primary panel-glow no-artifact ${className}`}>
...
function ServiceCard({
  ...
  return (
    <div className="group group-hover-outline-primary rounded-3xl border border-neutral-700/40 bg-card p-7 hover:border-primary transition-all duration-300 panel-glow no-artifact">
